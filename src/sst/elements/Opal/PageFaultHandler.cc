...
PageFaultHandler::PageFaultHandler(ComponentId_t id, Params& params) :
    ...
    if(!isPortConnected(linkname))
	    std::cout<<"The port isn't connecetd ******************"<<std::endl;
